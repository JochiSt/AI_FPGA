...
################################################################
# This is a generated script based on design: CLK_handling
#
...
# source CLK_handling_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set CLK20MHZ [ create_bd_port -dir O -type clk CLK20MHZ ]
  set CLK40MHZ [ create_bd_port -dir O -type clk CLK40MHZ ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {CLK20MHZ} \
   CONFIG.CLK_OUT2_PORT {CLK40MHZ} \
  ...
  connect_bd_net -net clk_wiz_0_CLK20MHZ [get_bd_ports CLK20MHZ] [get_bd_pins clk_wiz_0/CLK20MHZ]
  connect_bd_net -net clk_wiz_0_CLK40MHZ [get_bd_ports CLK40MHZ] [get_bd_pins clk_wiz_0/CLK40MHZ]
